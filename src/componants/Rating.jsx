...
function Rating() {
  return (
    <div className="min-h-[120px] bg-primary text-center grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-3 items-center text-white px-4 sm:px-8 lg:px-38 divide-y sm:divide-y-0 sm:divide-x divide-white/40">
      <div className="py-4">
